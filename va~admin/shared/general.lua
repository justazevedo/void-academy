commandsAdmin = {
    ...
    warpPlayer = { commandName = 'tpa', description = 'Telentrasporta para um jogador especifico.' },
    warpPlayerTo = { commandName = 'tpto', description = 'Telentrasporta o jogador para uma pessoa especifica.' },
