commandsAdmin = {
    ...
    setadmin = { 'setadmin', 'Seta o nivel do admin.' },
    banPlayer = { 'gban', 'Bani o jogador do servidor.' },
    ...
    destroyvehicle = { 'dv', 'Destroi o carro mais proximo.' },
    infosvehicle = { 'infoc', 'Checa as informações de um veiculo.' }
}